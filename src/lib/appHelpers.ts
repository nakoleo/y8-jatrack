...
export const TRANSITIONAL_SUPER_ADMIN_EMAIL = 'creative.y8pv@gmail.com';
...
export const isSuperAdminEmail = (email?: string | null) =>
  SUPER_ADMIN_EMAILS.includes(normalizeEmail(email) as typeof SUPER_ADMIN_EMAILS[number]);
